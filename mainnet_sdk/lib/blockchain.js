...
class Blockchain {
    constructor(blood) {
        this._provider = blood.getProvider();
    }
     ...
     * @returns {promise}
     */
    getBalance(address, tokenSymbol = "blood", useLongestChain = 0)
    {
     ...
     */
    getHabrosRatio() {
        return this._provider.send('get', 'getHabrosRatio');
    }
