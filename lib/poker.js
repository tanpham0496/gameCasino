...
Poker.newSet = function( options ) {
	...
	// console.log('no_joker, no_color, no_number, no_card', {no_joker, no_color, no_number, no_card});
	...
	// console.log('RED_JOKER', RED_JOKER)
	// console.log('BLACK_JOKER', BLACK_JOKER)
	// console.log('cards', cards);
	// console.log('Poker.visualize ', Poker.visualize(cards) );



	if(! no_joker) {
		Console.log('123123123231232312312312')
