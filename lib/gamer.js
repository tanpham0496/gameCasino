...
Gamer.prototype.onGamer_entergame = function(req, func) {
	...
	db.hgetall(uid_key, async function(err,userinfo){
		...
		switch(req.args){
			case 'holdem1' : 
				roomid = conf.games.holdem1.options.roomId;
				room_key = 'room:#' + roomid;
				gamer.room = roomid;
				break;
			// case 'holdem2' : 
			// 	roomid = conf.games.holdem2.options.roomId;
			// 	room_key = 'room:#' + roomid;
			// 	gamer.room = roomid;
			// 	break;
			// case 'holdem3' : 
			// 	roomid = conf.games.holdem3.options.roomId;
			// 	room_key = 'room:#' + roomid;
			// 	gamer.room = roomid;
			// 	break;
			// case 'holdem4' : 
			// 	roomid = conf.games.holdem4.options.roomId;
			// 	room_key = 'room:#' + roomid;
			// 	gamer.room = roomid;
			// 	break;
			// case 'holdem5' : 
			// 	roomid = conf.games.holdem5.options.roomId;
			// 	room_key = 'room:#' + roomid;
			// 	gamer.room = roomid;
			// 	break;
			// case 'holdem6' : 
			// 	roomid = conf.games.holdem6.options.roomId;
			// 	room_key = 'room:#' + roomid;
			// 	gamer.room = roomid;
			// 	break;
			// case 'hwatu' : 
			// 	roomid = conf.games.hwatu.options.roomId;
			// 	room_key = 'room:#' + roomid;
			// 	gamer.room = roomid;
			// 	break;
